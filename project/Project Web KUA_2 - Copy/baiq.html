...
<html lang="en">
  ...
  <body>
    ...
    <!-- Navbar -->
      ...
      <div class="container-fluid sticky-top">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="Index.php">Berita</a>
            </li>
            <li class="nav-item">
    ...
    <!-- Figures -->
     <a href="https://www.kochengoren.net/"><h3 class="text-center text-success mt-3">Biodata</h3></a>

    <!-- Isi Biodata Paling Keren di HTML disini -->
<div class="container">
  <div class="card kartu" style="width: 80%;">
    <div class="row">
      <div class="col-md-4" style="width: 29%;">
      <div class="foto">
        <img src="img/foto/foto_9.png" alt="" width="200" height="auto">
      </div>
      </div>
          ...
          <tbody>
            <tr>
              <td width="25%" valign="top" class="textt">Nama</td>
                <td width="2%">:</td>
                <td style="color: rgb(118, 157, 29); font-weight:bold; font-size: 24px;" class="underline-hover-effect">Baiq Muslimatusshalihah, S.Ag</td>
            </tr>
          <tr>
              <td class="textt">Jenis Kelamin</td>
                <td>:</td>
                <td class="underline-hover-effect">Perempuan</td>
            </tr>
          <tr>
              <td class="textt">Tempat/Tgl.lahir</td>
                <td>:</td>
                <td class="underline-hover-effect">Bangka, 03-07-1979</td>
            </tr>
          <tr>
              <td class="textt">Pangkat/Gol/Ruang</td>
                <td>:</td>
                <td class="underline-hover-effect">Penata Tk.I ( III / d )</td>
            </tr>
          <tr>
              <td class="textt">Jabatan</td>
                <td>:</td>
                <td class="underline-hover-effect">Penyusun Bahan Pembinaan Penghulu dan Penyuluh</td>
            </tr>
          <tr>
              <td valign="top" class="textt">Pendidikan</td>
                <td valign="top">:</td>
                <td class="underline-hover-effect">S.I</td>
            </tr>
            <tr>
              <td valign="top" class="textt">Alamat</td>
                <td valign="top">:</td>
                <td class="underline-hover-effect">Dasan Tereng Desa Dasan Lekong Kec. Selong</td>
            </tr>
            <tr>
              <td valign="top" class="textt">NIP</td>
                <td valign="top">:</td>
                <td class="underline-hover-effect">197907032009122004</td>
            </tr>
    ...
    <div class="tupoksi text-center">
      <h5>Tupoksi</h5>

      <div class="garis container" style="width: 30%; position: relative; bottom: 10px; height: 30px;">
        <hr class="mb-4">
      </div>

      <p style="position: relative; bottom: 30px; padding: 10px;">
        "Melaksanakan tugas dan jabatan sebagai Penyusun Bahan Pembinaan Penghulu dan Penyuluh"
      </p>
    ...
    <div class="tugas">
      <h5 class="text-center">Uraiyan Tugas</h5>
      ...
      <p style="position: relative; bottom: 30px; padding: 10px;">
        <ol style="position: relative; bottom: 50px;">
          <li>
            Menyusun jadwal penasehatan dan konsultasi NR 
          </li>

          <br>

          <li>
            Menyusun materi dan desain pelaksanaan konseling / penasehatan  
          </li>

          <br>

          <li>
            Menganalisa kebutuhan konseling / penasehatan catin
          </li>

          <br>

          <li>
            Mengevaluasi rangkaian kegiatan konseling / penasehatan catin
          </li>

          <br>

          <li>
            Membuat laporan penasehatan dan konseling NR
          </li>

          <br>

          <li>
             Mengentry data catin pada aplikasi Simkah
          </li>

          <br>

          <li>
            Menulis/Print Out Akta Nikah dan Kutipan Akta Nikah
          </li>
          <br>

          <li>
            Menyiapkan berkas nikah untuk pelaksanaan Akad Nikah
          </li>
          <br>

          <li>
            membuat laporan Administrasi pernikahan 
          </li>
